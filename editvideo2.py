...
# Process images and create zoomed frames in parallel
def process_image(image_file):
    ...
    try:
        ...
        video_clip = mp.ImageSequenceClip([cv2.cvtColor(frame, cv2.COLOR_RGB2BGR) for frame in zoom_frames], fps=30)
