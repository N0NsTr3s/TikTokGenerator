...
def main():
	...
	with torch.inference_mode():
		...
		microsoftspeech_tts_24 = microsoftspeech_tts.text_2_audio(voice="en-US:Steffan(Male)", rate=0, filename_prefix="comfyUIVoiceTTK", text=content+"\n\n If you want to check your news, please write it`s title in the comments!")
...
if __name__ == "__main__":
    ...
    audio_directory = os.path.join(parent_dir, "ComfyUI", "output", "audio")
